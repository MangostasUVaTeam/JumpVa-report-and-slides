...
%----------------------------------------------------------------------------------------
	...
	\end{abstract}
		...
		\section{Descripción del Problema}
			...
			\paragraph{}
			Dependiendo de cómo se contrate el transporte existen dos formas de pago: por parte del remitente o por parte del destinatario. Actualmente el método más utilizado es el de pago del destinatario pero aún así existen casos especiales en los que no. También existen dos métodos de calcular el precio del transporte: aplicando una tarifa fija (lo cual muchas veces infla los costes de manera innecesaria) o teniendo en cuenta la distancia recorrida desde el origen hasta el destino.
